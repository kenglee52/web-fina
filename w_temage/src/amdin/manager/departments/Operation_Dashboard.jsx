...
const Operation_Dashboard = () => {
  ...
  if (!admin || admin.department_name !== 'Operations') {
  ...
  useEffect(() => {
    const fetchApplicants = async () => {
      ...
      try {
        ...
        const applicantsResponse = await axios.get(`${url.base_url}/api/applicants_manager?department=Operations`, {
        ...
        const unreadResponse = await axios.put(`${url.base_url}/api/applicants/unread?department=Operations`, {}, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  return (
    <div className="max-w-full mx-auto p-6 bg-gradient-to-br from-purple-50 to-white min-h-screen">
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-600">No applicants found for Operations department.</div>
      ) : (
...
export default Operation_Dashboard;