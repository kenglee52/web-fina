...
const MarketingDashboard = () => {
  ...
  if (!admin || admin.department_name !== 'Customer Service') {
  ...
  useEffect(() => {
    const fetchApplicants = async () => {
      ...
      try {
        ...
        console.log('Fetching Customer Service applicants with token:', token);
        const applicantsResponse = await axios.get(`${url.base_url}/api/applicants_manager?department=Customer Service`, {
        ...
        const unreadResponse = await axios.put(`${url.base_url}/api/applicants/unread?department=Customer Service`, {}, {
          headers: { Authorization: `Bearer ${token}` },
        });
    ...
    <div className="max-w-full mx-auto p-6 bg-gradient-to-br from-purple-50 to-white min-h-screen">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-extrabold tracking-tight">
          ...
          <span className="text-gray-900"> Customer Service Department Dashboard</span>
        </h1>
        <button
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-600">No applicants found for Customer Service department.</div>
      ) : (
