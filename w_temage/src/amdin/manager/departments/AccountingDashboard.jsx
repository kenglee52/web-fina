...
const AccountingDashboard = () => {
  ...
  if (!admin || admin.department_name !== 'Accounting and Finance') {
  ...
  useEffect(() => {
    const fetchApplicants = async () => {
      ...
      try {
        ...
        const applicantsResponse = await axios.get(`${url.base_url}/api/applicants_manager?department=Accounting and Finance`, {
        ...
        const unreadResponse = await axios.put(`${url.base_url}/api/applicants/unread?department=Accounting and Finance`, {}, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  return (
    <div className="max-w-full mx-auto p-6 bg-gradient-to-br from-purple-50 to-white min-h-screen">
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-600">No applicants found for Accounting and Finance department.</div>
      ) : (
