...
const ManagementDashboard = () => {
  ...
  if (!admin || admin.department_name !== 'FINA Management') {
  ...
  useEffect(() => {
    const fetchApplicants = async () => {
      ...
      try {
        ...
        console.log('Fetching Management applicants with token:', token);
        const applicantsResponse = await axios.get(`${url.base_url}/api/applicants_manager?department=FINA Management`, {
        ...
        const unreadResponse = await axios.put(`${url.base_url}/api/applicants/unread?department=FINA Management`, {}, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  return (
    <div className="max-w-full mx-auto p-6 bg-gradient-to-br from-purple-50 to-white min-h-screen">
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-600">No applicants found for FINA Managements department.</div>
      ) : (
