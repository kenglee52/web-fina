...
const AdministrationDashboard = () => {
  ...
  if (!admin || admin.department_name !== 'Admin and Customer Service') {
  ...
  useEffect(() => {
    const fetchApplicants = async () => {
      ...
      try {
        ...
        console.log('Fetching Administration applicants with token:', token);
        const applicantsResponse = await axios.get(`${url.base_url}/api/applicants_manager?department=Admin and Customer Service`, {
        ...
        const unreadResponse = await axios.put(`${url.base_url}/api/applicants/unread?department=Admin and Customer Service`, {}, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  return (
    <div className="max-w-full mx-auto p-6 bg-gradient-to-br from-purple-50 to-white min-h-screen">
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-600">No applicants found for Admin and Customer Service department.</div>
      ) : (
